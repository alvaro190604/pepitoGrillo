...
public class MainTableroEj12 {
	...
	public static void main(String[] args) {
		...
		if (respuesta1.equals("si")) {
			...
			tablero.imprimirTablero();
			System.out.println("La distancia euclídea del punto " + tablero.getP().toString() + "con el punto (" + respuesta2 + "," + respuesta3 + ") es: " + tablero.imprimirDistanciaEuclidea(respuesta2, respuesta3));
